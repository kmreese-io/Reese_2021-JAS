...
for(i in 1:nrow(habitations.with.pitstructures)) {
  household.allotment[i,] <- round(as.matrix(peak.population[i,] * normalize(habitations.with.pitstructures[i,8:ncol(habitations.with.pitstructures)])))
}
...
household.allotment <- matrix(NA,nrow=nrow(habitations.with.pitstructures),ncol=length(8:ncol(habitations.with.pitstructures)))
for(i in 1:nrow(habitations.with.pitstructures)) {
  household.allotment[i,] <- round(as.matrix(habitations.with.pitstructures[i,]$PITSTRUCTURES * normalize(habitations.with.pitstructures[i,8:ncol(habitations.with.pitstructures)])))
}
